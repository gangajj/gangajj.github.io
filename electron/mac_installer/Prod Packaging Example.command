...
APP_EXE="release-builds/Ganga.com-darwin-x64/${APP_NAME}.app/Contents/MacOS/${APP_NAME}"

VOL_NAME="${APP_NAME}_${VERSION}"   # volume name will be "Ganga 1.0.0"
DMG_TMP="${VOL_NAME}-temp.dmg"
DMG_FINAL="${VOL_NAME}.dmg"         # final DMG name will be "Ganga 1.0.0.dmg"
...
echo "creating /Volumes/${VOL_NAME}/.background"
...
echo '
   tell application "Finder"
     tell disk "'${VOL_NAME}'"
           ...
           set the bounds of container window to {400, 100, 927, 550}
